...
// If compiled for Nano, OTA is not available.
...
// This can be updated via LOW-pulse on DPIN_OTA, which will cause us to open a web page
...
// connections: NOTE: these are good pins for most ESP32 - see https://randomnerdtutorials.com/esp32-pinout-reference-gpios/
//              if using an ESP32-S3, see https://randomnerdtutorials.com/esp32-s3-devkitc-pinout-guide/
//
...
D2-D13: General-purpose digital input/output pins
...
#define DPIN_SRL_RX     10  // SW-serial in  - talk to DFPlayer audio player (YX5200)
#define DPIN_SRL_TX     11  // SW-serial out - talk to DFPlayer audio player (YX5200)
#define DPIN_AUDIO_BUSY 12  // digital input - HIGH when audio finishes
